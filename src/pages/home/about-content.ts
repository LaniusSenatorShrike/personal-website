export const aboutContent = {
  ...
  bio: {
    title: "Background",
    paragraphs: [
      "Tech Lead at Marktplaats leading data infrastructure transformation. Expert in building scalable ETL pipelines, real-time streaming with Kafka, and cloud architecture.",
